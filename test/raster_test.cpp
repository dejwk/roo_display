...
TEST(Raster, MonochromeMsbFirst) {
  ...
  RasterMonochrome<ConstDramResource> raster(4, 6, data, WhiteOnBlack());
...
TEST(Raster, MonochromeLsbFirst) {
  uint8_t data[] = {0xC1, 0x26, 0xE7};
  RasterMonochrome<ConstDramResource, COLOR_PIXEL_ORDER_LSB_FIRST> raster(
...
TEST(Raster, Grayscale4MsbFirst) {
  uint8_t data[] = {0xC1, 0x26, 0xE7};
  RasterGrayscale4<ConstDramResource> raster(3, 2, data);
...
TEST(Raster, Grayscale4LsbFirst) {
  uint8_t data[] = {0xC1, 0x26, 0xE7};
  RasterGrayscale4<ConstDramResource, COLOR_PIXEL_ORDER_LSB_FIRST> raster(3, 2,
                                                                          data);
  EXPECT_THAT(raster, MatchesContent(Grayscale4(), 3, 2,
                                     "1C6"
                                     "27E"));
...
TEST(Raster, Alpha4MsbFirst) {
  uint8_t data[] = {0xC1, 0x26, 0xE7};
  RasterAlpha4<ConstDramResource> raster(3, 2, data, Alpha4(color::Red));
...
TEST(Raster, Alpha4LsbFirst) {
  uint8_t data[] = {0xC1, 0x26, 0xE7};
  RasterAlpha4<ConstDramResource, COLOR_PIXEL_ORDER_LSB_FIRST> raster(
...
TEST(Raster, Grayscale8) {
  ...
  RasterGrayscale8<ConstDramResource> raster(3, 2, data);
...
TEST(Raster, Alpha8) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04};
  RasterAlpha8<ConstDramResource> raster(3, 2, data, Alpha8(color::Lime));
...
TEST(Raster, Argb4444BigEndian) {
  ...
  RasterArgb4444<ConstDramResource> raster(3, 2, data);
  EXPECT_THAT(raster, MatchesContent(Argb4444(), 3, 2,
                                     "C126 E754 F304"
                                     "DD39 2E80 11F5"));
}
...
TEST(Raster, Argb4444LittleEndian) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04,
                    0xDD, 0x39, 0x2E, 0x80, 0x11, 0xF5};
  RasterArgb4444<ConstDramResource, BYTE_ORDER_LITTLE_ENDIAN> raster(3, 2,
                                                                     data);
  EXPECT_THAT(raster, MatchesContent(Argb4444(), 3, 2,
                                     "26C1 54E7 04F3"
                                     "39DD 802E F511"));
...
TEST(Raster, Argb6666BigEndian) {
  ...
  RasterArgb6666<ConstDramResource> raster(3, 2, data);
...
TEST(Raster, Argb6666LittleEndian) {
  ...
  RasterArgb6666<ConstDramResource, BYTE_ORDER_LITTLE_ENDIAN> raster(3, 2,
                                                                     data);
  EXPECT_THAT(raster, MatchesContent(Argb6666(), 3, 2,
                                     "**__ *_*_ *__*"
                                     "**** ____ DHv_"));
...
TEST(Raster, Argb8888BigEndian) {
  ...
  RasterArgb8888<ConstDramResource> raster(3, 2, data);
  EXPECT_THAT(raster, MatchesContent(Argb8888(), 3, 2,
...
TEST(Raster, Argb8888LittleEndian) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04, 0x22, 0x5F,
                    0x65, 0x01, 0x86, 0x00, 0xCA, 0xFE, 0xBA, 0xBE,
                    0xDE, 0xAD, 0xDD, 0x39, 0x2E, 0x80, 0x11, 0xF5};
  RasterArgb8888<ConstDramResource, BYTE_ORDER_LITTLE_ENDIAN> raster(3, 2,
                                                                     data);
  EXPECT_THAT(raster, MatchesContent(Argb8888(), 3, 2,
...
TEST(Raster, Rgb565BigEndian) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04,
                    0xDD, 0x39, 0x2E, 0x80, 0x11, 0xF5};
  RasterRgb565<ConstDramResource> raster(3, 2, data);
...
TEST(Raster, Rgb565LittleEndian) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04,
                    0xDD, 0x39, 0x2E, 0x80, 0x11, 0xF5};
  RasterRgb565<ConstDramResource, BYTE_ORDER_LITTLE_ENDIAN> raster(3, 2, data);
  EXPECT_THAT(raster, MatchesContent(Rgb565(), 3, 2,
                                     "7r1 JcD _cc"
                                     "DDw W0R ydY"));
}
...
TEST(Raster, Rgb565WithTransparencyBigEndian) {
  uint8_t data[] = {0xC1, 0x26, 0xE7, 0x54, 0xF3, 0x04,
                    0xDD, 0x39, 0x2E, 0x80, 0x11, 0xF5};
  RasterRgb565WithTransparency<ConstDramResource> raster(
