...
void writeEXIO(TwoWire &wire, uint8_t &shadow, uint8_t pin, bool state) {
...
WaveshareEsp32s3TouchLcd43::WaveshareEsp32s3TouchLcd43(Orientation orientation,
                                                       decltype(Wire) &wire)
    : wire_(wire),
...
// Verifies PSRAM and initializes I2C bus and GT911 reset.
...
DisplayDevice &WaveshareEsp32s3TouchLcd43::display() { return display_; }

TouchDevice *WaveshareEsp32s3TouchLcd43::touch() { return &touch_; }
